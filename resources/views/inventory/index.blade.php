        ...
        <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            ...
            <div class="flex flex-col gap-2 sm:flex-row sm:flex-wrap">
                <form class="flex gap-2" method="get" action="{{ route('inventory.index') }}">
                    <input name="q" value="{{ $search }}" class="w-full rounded-lg border border-black/20 bg-white px-3 py-2 text-sm sm:w-auto" type="text" placeholder="Cari produk/barcode" />
