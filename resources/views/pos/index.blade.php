    ...
    <div class="grid gap-4 lg:gap-6 lg:grid-cols-[1.2fr_0.8fr]">
        <section class="min-w-0 rounded-2xl border border-black/10 bg-white p-5 shadow-sm">
            ...
            <div class="mt-4 rounded-xl border border-black/10 bg-[#fdf8ef] p-4">
                ...
                <p class="mt-2 text-xs text-black/60">Ketik nama produk untuk mencari, atau klik tombol "Scan Barcode"
                    untuk
                    scan.</p>
            </div>
            ...
            <div class="mt-5">
                    ...
                    <table class="w-full min-w-[500px] text-left text-xs">
                        ...
                        <tbody>
                            ...
                            <tr class="border-t border-black/10">
                                <td class="px-4 py-4 text-center text-black/60" colspan="5">Belum ada barang.
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
                ...
                <div class="mt-3 flex items-center justify-between text-sm">
                    ...
                    <button type="button" class="text-xs font-semibold text-red-600"
                        onclick="confirmClearCart()">Bersihkan
                        Keranjang</button>
                </div>
            </div>
        </section>
        ...
        <aside class="min-w-0 rounded-2xl border border-black/10 bg-white p-5 shadow-sm">
            ...
            <form id="checkout-form" class="mt-4 space-y-3 text-sm" method="post"
                ...
                <div>
                    ...
                    <select name="payment_method"
                        class="w-full rounded-lg border border-black/20 bg-white px-3 py-2 text-sm"
                ...
                <div>
                    ...
                    <input id="change-input"
                        class="w-full rounded-lg border border-black/20 bg-gray-50 px-3 py-2 text-sm" type="text"
    ...
    <div id="scan-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 p-2 sm:p-4">
        <div
            ...
            <div class="flex items-center justify-between">
                ...
                <button id="close-scan-modal" type="button"
                    ...
                    <div id="scanner-wrapper"
                        ...
                        <div id="scan-overlay"
                            ...
                            <div class="relative h-full w-full">
                                ...
                                <div class="absolute bottom-4 left-4 h-6 w-6 border-b-2 border-l-2 border-red-500">
                                </div>
                                <div class="absolute bottom-4 right-4 h-6 w-6 border-b-2 border-r-2 border-red-500">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="mt-4">
                ...
                <form id="quantity-form" class="mt-4" method="post" action="{{ route('pos.items.add') }}">
                    ...
                    <div class="mt-6 flex gap-2">
                        ...
                        <button type="submit" class="btn-primary flex-1" data-loading-text="Menambahkan...">Tambah
                            ke
                            Keranjang</button>
                    </div>
                </form>
    ...
    <x-confirm-modal id="remove-item-modal" title="Hapus Item"
        message="Apakah Anda yakin ingin menghapus item ini dari keranjang?" confirm-text="Ya, Hapus"
        cancel-text="Batal" confirm-type="danger" icon="warning" />
    ...
    <script>
        ...
        if (openScanModal) {
            openScanModal.addEventListener('click', () => {
                ...
                const startCamera = () => {
                    if (scanToggle && window.posScanner) {
                        scanToggle.click();
                    } else {
                        // Retry jika scanToggle belum ready
