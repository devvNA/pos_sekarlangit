    ...
    <body>
        <div class="min-h-screen md:flex">
            <aside id="app-sidebar"
                class="fixed inset-y-0 left-0 z-40 hidden w-64 flex-col overflow-y-auto px-4 py-4 shadow-lg md:static md:flex md:shadow-none"
            ...
            <div class="flex-1 overflow-x-hidden">
                <header class="flex items-center justify-between border-b-4 px-3 py-3 shadow-md sm:px-4 sm:py-4 md:px-6"
                    ...
                    <button id="sidebar-toggle"
                        class="shrink-0 rounded-lg border-2 px-3 py-2 text-sm font-bold text-white md:hidden"
                        type="button" style="background-color: #1b6b42; border-color: #1b6b42;">Menu</button>
                    <div class="hidden text-lg font-semibold text-gray-900 md:block">Sistem POS untuk Toko Sekarlangit
                    </div>
